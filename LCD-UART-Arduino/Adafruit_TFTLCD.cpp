...
Adafruit_TFTLCD::Adafruit_TFTLCD(
  ...
  wrPinUnset = ~wrPinSet;
  rdPinUnset = ~rdPinSet;
  /*Serial.println(csPinSet,HEX);
  Serial.println(cdPinSet,HEX);
  Serial.println(wrPinSet,HEX);
  Serial.println(rdPinSet,HEX);
  
  Serial.println(csPinUnset,HEX);*/
/*  Serial.println(cdPinUnset,HEX);
  Serial.println(wrPinUnset,HEX);
  Serial.println(rdPinUnset,HEX);*/
...
void Adafruit_TFTLCD::begin(uint16_t id) {
  ...
  if((id == 0x9325) || (id == 0x9328)) {
    ...
    driver = ID_9341;
    CS_ACTIVE;
    //Serial.print("CS_ACTIVE: ");Serial.println(CS_ACTIVE,BIN);
...
//  CD_DATA;
  WR_IDLE;
  RD_IDLE;
  /*Serial.print("CS_IDLE: ");Serial.println(CS_IDLE,BIN);
  Serial.print("WR_IDLE: ");Serial.println(WR_IDLE,BIN);
  Serial.print("RD_IDLE: ");Serial.println(RD_IDLE,BIN);*/
#ifdef USE_ADAFRUIT_SHIELD_PINOUT
  digitalWrite(5, LOW);
  delay(2);
  digitalWrite(5, HIGH);
  ...
  CD_COMMAND;
  /*Serial.print("CS_ACTIVE: ");Serial.println(CS_ACTIVE,BIN);
  Serial.print("CD_COMMAND: ");Serial.println(CD_COMMAND,BIN);*/
  write8(0x00);
